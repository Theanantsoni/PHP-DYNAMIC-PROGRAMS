...
<body bgcolor="#f5fe04">
	<center>
	<form action="birthday_display.php" method="POST">
		<h1>-------------------------------- : Fill The Basic Details For Birthday Wishing Letter : --------------------------------</h1>
		<label style="color:red; font-size:30px;">Enter Your Friend Name : </label>
		<input type="text" name="txtname" size="30" placeholder="Enter Your Friend Name" style="background-color:#ffc0c0;  padding: 10px 20px; margin: 4px 2px; cursor:space;  font-size: 15px;"> <br><br>

		<label style="color:red; font-size:30px;">Enter Your Friend Address : </label>
		<textarea cols="30" rows="5" name="txtadd1" size="30" placeholder="Enter Your Friend Address" style="background-color:#ffc0c0;  padding: 10px 20px; margin: 4px 2px; cursor:space;  font-size: 15px;"> </textarea> <br><br>

		
		<label style="color:red; font-size:30px;">Enter Your Friend City : </label>
	...
	<label style="color:red; font-size:30px;">Enter Your Friend's Area Pin Code No : </label>
...
<?php
	//204, kiran chembers, mangal group society, ved road, katargam 
	// A-22, opp. Avadh Hotel, Apple Company, mota-varachha
?>