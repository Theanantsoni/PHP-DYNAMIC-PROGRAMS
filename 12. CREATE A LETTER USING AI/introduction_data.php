...
<body bgcolor="#f5fe04">
	<center>
	<form action="introduction_display.php" method="POST">
		<h1>-------------------------------- : Fill The Basic Details For Create Introduction Letter : --------------------------------</h1>
	...
	<label style="color:red; font-size:30px;">Name Of Recipient : </label>
	<input type="text" name="txtrecname" size="30" placeholder="Enter Recipient Name" style="background-color:#ffc0c0;  padding: 10px 20px; margin: 4px 2px; cursor:space;  font-size: 15px;"> <br><br>

	<label style="color:red; font-size:30px;">Enter Company Name : </label>
	<input type="text" name="txtcmpnyname" size="30" placeholder="Enter Company Name" style="background-color:#ffc0c0;  padding: 10px 20px; margin: 4px 2px; cursor:space;  font-size: 15px;"> <br><br>

	<label style="color:red; font-size:30px;">Enter Company Address : </label>
	<textarea cols="30" rows="5" name="txtadd2" size="30" placeholder="Enter Comapany Address" style="background-color:#ffc0c0;  padding: 10px 20px; margin: 4px 2px; cursor:space; font-size: 15px;"> </textarea> <br><br>

	<label style="color:red; font-size:30px;">Enter Your City : </label>
		<select name="drpcity2">
			<option value="Kutch">Kutch</option>
			<option value="Vadodara">Vadodara</option>
			<option value="Dang">Dang</option>
			<option value="Bhuj">Bhuj</option>
	...
	<label style="color:red; font-size:30px;">Enter Area Pin Code No : </label>
	<input type="text" name="txtpin2" size="30" placeholder="Enter Area Pin Code No." style="background-color:#ffc0c0;  padding: 10px 20px; margin: 4px 2px; cursor:space;  font-size: 15px;"> <br><br>
