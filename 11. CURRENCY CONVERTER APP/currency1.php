	...
	<center>
		<h1 style="color:#6512ff; font-size: 50px; border:solid 5px; border-color:red; border-radius:5px; cursor:pointer;">Convert RS To All five Currency</h1>
			<form action="currency1_1.php" method="POST">
				...
				<label style="color:red; font-size:30px;">A. Enter The Today's Rate Of US Dollar : </label>
				...
				<label style="color:red; font-size:30px;">B. Enter The Today's Rate Of Canadian Dollar : </label>
				...
				<label style="color:red; font-size:30px;">C. Enter The Today's Rate Of Pound : </label>
				...
				<label style="color:red; font-size:30px;">D. Enter The Today's Rate Of Yen : </label>
				...
				<label style="color:red; font-size:30px;">E. Enter The Today's Rate Of Dirham (Dubai) :</label>
				...
				<h4 style="color:#680000; font-size:30px;">Enter The RS That You Want To Convert Into All Five Currencies : </h4> 
				...
				<input type="submit" name="btnsubmit" value="CHECK" style="color:yellow; background-color: red; padding:10px 20px; margin:4px 2px; cursor:space; border:groove 20px; font-size: 30px; border-radius:500px; ">

				<button style="color:yellow; background-color: red; padding:10px 20px; margin:4px 2px; cursor:space; border:groove 20px; font-size: 30px; border-radius:500px;"><a href="currency.php" style="text-decoration: none; color:yellow;">BACK</a></button>
			</form>
	</center>
</body>
</html>